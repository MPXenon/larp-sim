...
character_names = ['Fighter','Scout','Berserker','Dark warlock','Fire warlock','Fireball pyromancer','Blaster priest','Basic healbot priest','Basic armour priest','Basic weakness priest']
character_objects = [Fighter,Scout,Berserker,Darkness_Warlock,Fire_Warlock,Fireball_Pyromancer,Blaster_Priest,Basic_Healbot_Priest,Basic_Armour_Priest,Basic_Weakness_Priest]
